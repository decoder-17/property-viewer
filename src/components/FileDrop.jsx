...
export default function FileDrop() {
  return (
    <div className="flex flex-col flex-grow bg-white m-4 p-4 rounded-3xl ">
      <div class="font-sans text-gray-900 bg-gray-300 border-box rounded-2xl h-full">
          ...
          <div class="flex flex-col items-center justify-center w-full h-auto my-20 bg-white sm:w-3/4 sm:rounded-lg sm:shadow-xl">
            <div class="mt-10 mb-10 text-center">
              ...
              <p class="text-xs text-gray-500">
                File should be of format .ear, .xsd
              </p>
            </div>
            <form
              action="#"
